...
contract WonderWorld is ERC20DividendToken {

    uint256 private _tokenSupply = 500000000000000;
    ...
    constructor () ERC20DividendToken("Wonder World", "WWD", _tokenSupply, _routerAddress, _marketingAddress) {
